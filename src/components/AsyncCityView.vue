<template>
  <div class="mb-10 flex flex-col flex-1 items-center">
    <!-- BANNER -->
    <div
    ...
    >
      <p>
        You're currently previewing this city, click '+' to start tracking this
        city
      </p>
    </div>
    <!-- Weather overview -->
    ...
    <div class="max-w-screen-md w-full py-12">
      <div class="mx-8 text-white">
        ...
        <div
          class="flex gap-10 scrollbar scrollbar-thumb-weather-secondary scrollbar-track-weather-primary overflow-x-scroll"
        >
          <div
            v-for="hourData in weatherData.hourly"
            :key="hourData.dt"
            class="mb-6 flex flex-col gap-4 items-center"
          >
